                        ...
                        <form action="/member" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input name="name" id="inputName" type="text"
                                    class="form-control bg-light border-0 small mb-2 @error('name') is-invalid @enderror" placeholder="Masukan nama" value="{{ old('name') }}">
                                @error('name')
                            ...
                            <div class="row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input name="nisn" id="inputNisn" type="text"
                                        class="form-control bg-light border-0 small mb-2 @error('nisn') is-invalid @enderror" placeholder="Masukan NISN" value="{{ old('nisn') }}">
                                    @error('nisn')
                                        <div class="invalid-feedback">
                                            {{ $errors->first('nisn') }}
                                        </div>
