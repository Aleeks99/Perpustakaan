                ...
                <table class="table table-bordered" id="classroomTable" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="/classroom/{{ $classroom->id }}/edit" class="btn btn-light btn-icon-split">
                                    <span class="icon text-gray-600">
                                        <i class="fas fa-edit"></i>
                                    </span>
                                </a>

                                <form action="/classroom/{{ $classroom->id }}" method="POST" class="d-inline">
                                    @method('delete')
                                    @csrf
                                    <button class="btn btn-danger" onclick="return confirm('Apakah yakin untuk menghapus kelas {{ $classroom->name }}?')">
                                        <span class="icon text-white-50">
