            ...
            <div class="col-lg-6">
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        <h6 class="m-0 font-weight-bold text-primary">Formulir Buku</h6>
                    </div>
                    <div class="card-body">
                        <form action="/books" method="POST">
                            ...
                            <div class="row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input name="author" id="inputAuthor" type="text"
                                        ...
                                        placeholder="Masukan penulis buku" value="{{ old('author') }}">
                                    @error('author')
                                        <div class="invalid-feedback">
                                            Penulis harus diisi
                                        </div>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input name="publisher" id="inputPublisher" type="text"
                                        ...
                                        placeholder="Masukan penerbit buku" value="{{ old('publisher') }}">
                                    @error('publisher')
                                        <div class="invalid-feedback">
                            ...
                            <div class="row">
                                <div class="form-group col-md-5">
                                    <label for="inputCategory" class="form-label">Kategori<span class="text-danger">*</span></label>
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input name="isbn" id="inputISBN" type="text"
                                        ...
                                        placeholder="Masukan ISBN buku" value="{{ old('isbn') }}">
                                    @error('isbn')
                                        <div class="invalid-feedback">
                                            ISBN harus diisi
                                        </div>
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="description" class="form-control bg-light border-0 small mb-2" id="inputAddress" rows="4"
                                    placeholder="Masukan deskripsi buku">{{ old('description') }}</textarea>
                            </div>
                            <br>
